lcr-modules:
    ...
    battenberg:
        inputs:
            ...
            sample_bam: "data1/{sample_id}.bam"
        
        reference_path:
            hg38: " --chr_prefixed_genome "                           # Copied from vcf2maf
            grch37: " "     # Copied from vcf2maf

    mutect2:
        inputs:
            sample_bam: "data1/{sample_id}.bam"
            sample_bai: "data1/{sample_id}.bam.bai"
    ...
    liftover:
        tool: "battenberg" 
        dirs: 
            _parent: "results/battenberg_liftover-1.2"
        inputs:
            sample_seg: "data/battenberg/hg38/TCRBOA7-T-WEX--TCRBOA7-N-WEX_subclones.igv.seg"
    ...
    mixcr:
        inputs:
            sample_fastq_1: "data1/{sample_id}.read1.fastq.gz"
            sample_fastq_2: "data1/{sample_id}.read2.fastq.gz"
    ...
    utils:
        inputs:
            bed: 
                grch37: "data1/exome_bed/hg19/target_regions.nochr.bed" # make sure this corresponds with config["lcr-modules"]["picard_qc"]["inputs"]["intervals"]
