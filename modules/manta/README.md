...
The `manta` is a Level 2 module that operates on `BAM/CRAM` files to use Manta and perform Structural variants for `capture, genome, mrna` data. It generates `VCF` files as outputs.
...
See the full changelog [here](https://github.com/LCR-BCCRC/lcr-modules/blob/master/modules/manta/CHANGELOG.md)
