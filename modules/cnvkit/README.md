...
The `cnvkit` is a Level 2 module that operates on `BAM/CRAM` files to use CNV kit and perform CNV calling for `capture, genome` data. It generates `SEG` files as outputs.
...
See the full changelog [here](https://github.com/LCR-BCCRC/lcr-modules/blob/master/modules/cnvkit/CHANGELOG.md)
