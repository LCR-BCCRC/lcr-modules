...
The `stringtie` is a Level 2 module that operates on `BAM/CRAM` files to use Stringtie and perform Gene expression for `mrna` data. It generates `GTF` files as outputs.
...
See the full changelog [here](https://github.com/LCR-BCCRC/lcr-modules/blob/master/modules/stringtie/CHANGELOG.md)
