...
The `hmftools` is a Level 2 module that operates on `BAM/CRAM` files to use HMFtools ( and perform Structural variants for `genome` data. It generates `VCF` files as outputs.
...
See the full changelog [here](https://github.com/LCR-BCCRC/lcr-modules/blob/master/modules/hmftools/CHANGELOG.md)
