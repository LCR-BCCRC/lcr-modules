...
The `varscan` is a Level 2 module that operates on `BAM` files to use VarScan and perform Variant calling for `capture, genome` data. It generates `VCF` files as outputs.
...
See the full changelog [here](https://github.com/LCR-BCCRC/lcr-modules/blob/master/modules/varscan/CHANGELOG.md)
