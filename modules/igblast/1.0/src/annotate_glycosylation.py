...
Reads sequence_alignment_aa from the igblastn AIRR TSV (--source_tsv), keyed
...
def load_aa_by_sequence_id(tsv_path):
    """Build {sequence_id: sequence_alignment_aa} from an igblastn AIRR TSV."""
    aa_by_id = {}
...
def main():
    ...
    parser.add_argument("--source_tsv", required=True,
                        help="igblastn AIRR TSV with a sequence_alignment_aa column.")
