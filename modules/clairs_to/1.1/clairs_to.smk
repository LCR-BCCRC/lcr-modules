...
#     output:
#         indel_vcf = CFG["dirs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/indel.vcf.gz",
#         indel_tbi = CFG["dirs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/indel.vcf.gz.tbi",
#         snv_vcf = CFG["dirs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/snv.vcf.gz",
#         snv_tbi = CFG["dirs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/snv.vcf.gz.tbi"        
#     log:
...
rule _clairs_to_call_variants:
    input:
        ...
        fai = reference_files("genomes/{genome_build}/genome_fasta/genome.fa.fai")
    output:
        indel_vcf = CFG["dirs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/indel_TUMOR.vcf.gz",
        indel_tbi = CFG["dirs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/indel_TUMOR.vcf.gz.tbi",
        snv_vcf = CFG["dirs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/snv_TUMOR.vcf.gz",
        snv_tbi = CFG["dirs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/snv_TUMOR.vcf.gz.tbi"        
    log:
        stdout = CFG["logs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/clairs_to.stdout.log",
        stderr = CFG["logs"]["clairs_to"] + "{seq_type}--{genome_build}/{tumour_id}--{chemistry}--tumor_only/clairs_to.stderr.log"
    params:
