...
The `strelka` is a Level 2 module that operates on `BAM/CRAM` files to use Strelka2 and perform Variant calling for `capture, genome` data. It generates `VCF` files as outputs.
...
See the full changelog [here](https://github.com/LCR-BCCRC/lcr-modules/blob/master/modules/strelka/CHANGELOG.md)
