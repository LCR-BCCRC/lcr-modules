...
The `pathseq` is a Level 2 module that operates on `BAM/CRAM` files to use PathSeqPipelineSpark (GATK tools) and perform Pathogen analysis for `capture, genome, mrna` data. It generates `TSV` files as outputs.
...
See the full changelog [here](https://github.com/LCR-BCCRC/lcr-modules/blob/master/modules/pathseq/CHANGELOG.md)
