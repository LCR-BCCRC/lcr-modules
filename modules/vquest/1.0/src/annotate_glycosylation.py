...
Reads sequence_alignment_aa and germline_alignment_aa from the V-QUEST AIRR
...
def load_sequences_by_id(tsv_path):
    """
    Build {sequence_id: {"seq": str, "germline": str}} from a V-QUEST AIRR TSV.
...
def main():
    ...
    parser.add_argument("--source_tsv", required=True,
                        help="V-QUEST AIRR TSV with sequence_alignment_aa and "
