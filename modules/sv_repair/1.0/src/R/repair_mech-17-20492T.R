...
#    "/projects/rmorin/projects/gambl-repos/gambl-kcoyle/results/gambl/sv_repair-1.0/02-vcf_to_df/genome--hg38/09-27079T--09-27079N--matched/somaticSV.pass.precise.tsv",
    "/projects/rmorin/projects/gambl-repos/gambl-kcoyle/results/gambl/sv_repair-1.0/02-vcf_to_df/genome--hg38/17-20492T--17-20492N--matched/somaticSV.pass.precise.tsv",
    comment="#",
    col_names=TRUE
  )
 %>%
...
#    "/projects/rmorin/projects/gambl-repos/gambl-kcoyle/results/gambl/sv_repair-1.0/04-rmsk/genome--hg38/09-27079T--09-27079N--matched/intersect.rmsk.bed",
    "/projects/rmorin/projects/gambl-repos/gambl-kcoyle/results/gambl/sv_repair-1.0/04-rmsk/genome--hg38/17-20492T--17-20492N--matched/intersect.rmsk.bed",
    comment="#",
    header=TRUE,
    col.names = c("chr","start","end","chr.feature","start.feature","end.feature","name","length","strand","v1","v2","v3","v4","real.name", "v5","v6","v7","v8")
  ) %>%
...
#    "/projects/rmorin/projects/gambl-repos/gambl-kcoyle/results/gambl/sv_repair-1.0/05-nonb_dna/genome--hg38/09-27079T--09-27079N--matched/intersect.nonb.bed",
    "/projects/rmorin/projects/gambl-repos/gambl-kcoyle/results/gambl/sv_repair-1.0/05-nonb_dna/genome--hg38/17-20492T--17-20492N--matched/intersect.nonb.bed",
    comment="#",
    header = TRUE,
    col.names = c("chr","start","end","chr.feature","start.feature","end.feature","name","length","strand","v1","feature.name","v3","deets")
) %>% 
  mutate(
...
merged.1 <- base::merge( vcf, rmsk, by.x=c("chrom","end"), by.y=c("chr","end"))
merged <- base::merge( merged.1, non_b, by.x=c("chrom","end"), by.y = c("chr","end")) %>% 
  filter(SVTYPE == "BND") %>%
...
colnames(summary.repair) <- "17-20492T"
write.table(summary.repair, "/projects/rmorin/projects/gambl-repos/gambl-kcoyle/results/gambl/sv_repair-1.0/06-repair/genome--hg38/17-20492T--17-20492N--matched/repair.mech.tsv",  sep="\t", quote = FALSE)
write.table(paired, "/projects/rmorin/projects/gambl-repos/gambl-kcoyle/results/gambl/sv_repair-1.0/06-repair/genome--hg38/17-20492T--17-20492N--matched/repair.table.tsv", sep="\t", quote=FALSE, row.names = FALSE)
